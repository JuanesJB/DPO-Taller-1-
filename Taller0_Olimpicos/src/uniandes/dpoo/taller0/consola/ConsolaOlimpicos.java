...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Buscar el pais de un atleta");
	...
	/**
	 * TALLER 1 MODIFICACION 1
	 * Ejecuta la opción para consultar el pais al que pertenece un atleta.
	 */
	public void ejecutarPaisdelatleta()
	{
		
		System.out.println("\n" + "Buscar el pais de un atleta " + "\n");
		/**
		 * Pedimos el nombre del atelta para hacer la busqueda :
		 */
		String nombre = input("Ingrese el nombre del atleta  ");
		/**
		 * Con el nombre lo pasamos a la calculadora que creamos que identifica a que paia pertenece
		 */
		String pais = calculadora.paisatleta(nombre);
		/**
		 * Entregamos el resultado
		 */
		System.out.println("El atleta "+nombre+" pertenece a : "+pais);
